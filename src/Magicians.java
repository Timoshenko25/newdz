...
public class Magicians extends PersonBase{
    public Magicians (String name,Coordinates coordinates){
    ...
    public PersonBase Search_opponent(ArrayList<PersonBase> darkTeam,ArrayList<PersonBase> holyTeam){
        ...
        for (PersonBase param : holyTeam){
            if( param instanceof Peasant  || param instanceof Sniper ||param instanceof Infantry ){
    ...
    public String getInfo() {
        String s = name+"Координаты :"+coordinates+"жив"+getHp()+"количество стрел"+getArrows();
        return s;
    }
}